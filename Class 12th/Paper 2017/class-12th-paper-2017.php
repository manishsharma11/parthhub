...
<head>
	...
	<meta charset="utf-8" >
	<meta name="description" content="Class 12th CBSE Board Solved Paper 2017">
...
<body>
	...
	<div class="mdiv container">
		...
		<div style="padding-top:15px;clear:both;">
			<div class="movement">
				<a href="/">Home</a> » <a href="/Class 12th/class12th.php">Class 12th</a> » Class 12th Paper 2017 
			</div>
		</div>
		<?php
		...
		?>
			<div class="container-fluid row">
				<div class="div-container-left col-lg-9 col-sm-12 col-xs-12">
					<div class="headcont">
						<div class="headtop">
							<h4>Class 12th Paper and Solution - 2017</h4>
					...
					<div style="height:50px;">
						<div style="position:relative;">
							<ul id="htab">
								<li><a id="tr" href="class-12th-paper-2017.php?page=physics" name="tab2">Physics</a></li>
								<li><a id="tr" href="class-12th-paper-2017.php?page=chemistry" name="tab3">Chemistry</a></li>
								<li><a id="tr" href="class-12th-paper-2017.php?page=mathematics" name="tab1">Mathematics</a></li>
							</ul>
						</div>
					</div>
				</div>
