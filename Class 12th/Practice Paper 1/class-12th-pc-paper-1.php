...
<head>
	...
	<meta charset="utf-8" >
	<meta name="description" content="Class 12th CBSE Board Model Question Paper 2019">
...
<body>
	...
	<div class="mdiv container">
		...
		<div style="padding-top:15px;clear:both;">
			<div class="movement">
				<a href="/">Home</a> » <a href="/Class 12th/class12th.php">Class 12th</a> » Class 12th Practice Paper 1
			</div>
		</div>
		<?php
		...
		?>
			<div class="container-fluid row">
				<div class="div-container-left col-lg-9 col-sm-12 col-xs-12">
					<div class="headcont">
						<div class="headtop">
							<h4>Model Question Paper & Solution - 2019</h4>
							<h4 style="margin-top:15px;"> Class XII</h4>
							<h4></h4><br />
						</div>
						<div><span>Time Allowed : 3 hours</span></div>
						<div><span>Marks: 360</span></div>
					</div>
					<div style="height:50px;">
						<div style="position:relative;">
							<ul id="htab">
								<li><a id="tr" href="class-12th-pc-paper-1.php?page=physics" name="tab2">Physics</a></li>
								<li><a id="tr" href="class-12th-pc-paper-1.php?page=chemistry" name="tab3">Chemistry</a></li>
								<li><a id="tr" href="class-12th-pc-paper-1.php?page=mathematics" name="tab1">Mathematics</a></li>
							</ul>
						</div>
					</div>
				</div>
