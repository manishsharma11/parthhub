...
<body>
	...
	<div class="mdiv container">
		...
		<div style="padding-top:15px;clear:both;">
			<div class="movement">
				<a href="/">Home</a> » <a href="/Class 12th/class12th.php">Class 12th</a> » Class 12th Practice Paper 2
			</div>
		</div>
		<?php
				...
				<div class="div-container-left col-lg-9 col-sm-12 col-xs-12">
					...
					<div style="height:50px;">
						<div style="position:relative;">
							<ul id="htab">
								<li><a id="tr" href="class-12th-pc-paper-2.php?page=physics" name="tab2">Physics</a></li>
								<li><a id="tr" href="class-12th-pc-paper-2.php?page=chemistry" name="tab3">Chemistry</a></li>
								<li><a id="tr" href="class-12th-pc-paper-2.php?page=mathematics" name="tab1">Mathematics</a></li>
							</ul>
						</div>
					</div>
				</div>
